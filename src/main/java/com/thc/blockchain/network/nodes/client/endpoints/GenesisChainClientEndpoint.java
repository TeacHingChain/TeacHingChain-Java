...
public class GenesisChainClientEndpoint {
    ...
    public void onOpen(Session session) {
        ...
        GenesisBlock genesisBlock = new GenesisBlock(Constants.GENESIS_INDEX, Constants.GENESIS_TIMESTAMP, Constants.GENESIS_PSZ_TIMESTAMP, Constants.GENESIS_FROM_ADDRESS,
                Constants.GENESIS_TO_ADDRESS, Constants.GENESIS_TX_HASH, Constants.GENESIS_MERKLE_ROOT, Constants.GENESIS_NONCE, Constants.GENESIS_PREVIOUS_BLOCK_HASH, Constants.GENESIS_ALGO,
                Constants.GENESIS_HASH, Constants.GENESIS_TARGET, Constants.GENESIS_AMOUNT);
