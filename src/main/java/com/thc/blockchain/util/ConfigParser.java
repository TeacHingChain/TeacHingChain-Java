            ...
            if (configFile.exists()) {
                ...
                for (String configLine : configList) {
                    if (configLine.contains("node1")) {
                        ...
                        EndpointManager.node1ConfigIP = configLineSplit[1];
                        Constants.syncNode1FQN = "ws://" + EndpointManager.node1ConfigIP + ":" + Constants.commPort + "/server/" + Constants.syncKey;
                        Constants.updateNode1FQN = "ws://" + EndpointManager.node1ConfigIP + ":" + Constants.commPort + "/server/" + Constants.updateKey;
                        Constants.helloNode1FQN = "ws://" + EndpointManager.node1ConfigIP + ":" + Constants.commPort + "/server/" + Constants.helloKey;
                    } else if (configLine.contains("node2")) {
                        String[] configLineSplit = configLine.split("node2=");
                        EndpointManager.node2ConfigIP = configLineSplit[1];
                        Constants.syncNode2FQN = "ws://" + EndpointManager.node2ConfigIP + ":" + Constants.commPort + "/server/" + Constants.syncKey;
                        Constants.updateNode2FQN = "ws://" + EndpointManager.node2ConfigIP + ":" + Constants.commPort + "/server/" + Constants.updateKey;
                        Constants.helloNode2FQN = "ws://" + EndpointManager.node2ConfigIP + ":" + Constants.commPort + "/server/" + Constants.helloKey;
